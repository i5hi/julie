...
mod tests {
    ...
    fn core_composite() { 
        ...
        assert!(update_basic_auth(client_storage.clone(),client_auth.clone().uid, username, &p256.clone()));
        ...
        assert!(update_public_key(client_storage.clone(),client_auth.clone().uid, public_key));
